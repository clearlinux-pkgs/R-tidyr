...
Version  : 0.8.2
Release  : 16
URL      : https://cran.r-project.org/src/contrib/tidyr_0.8.2.tar.gz
Source0  : https://cran.r-project.org/src/contrib/tidyr_0.8.2.tar.gz
...
export LANG=C
export SOURCE_DATE_EPOCH=1540769621
