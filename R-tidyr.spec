...
Version  : 1.1.0
Release  : 38
URL      : https://cran.r-project.org/src/contrib/tidyr_1.1.0.tar.gz
Source0  : https://cran.r-project.org/src/contrib/tidyr_1.1.0.tar.gz
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1590376297
...
/usr/lib64/R/library/tidyr/help/figures/lifecycle-retired.svg
...
/usr/lib64/R/library/tidyr/tests/testthat/test-pack-name-repair.txt
